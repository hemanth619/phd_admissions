...
public function Header() {
        ...
        $this->Cell($this->PG_W, 8, "Shortlisted Candidates (SC Category)", 0, 0, 'C');
        $this->Ln();
...
$sql = 'SELECT * FROM selected where community = "SC"';
...
$sql1 = 'SELECT count(Appl) FROM selected where community = "SC"';
...
$sql2 = 'SELECT count(App_no) FROM list where community = "SC"';
