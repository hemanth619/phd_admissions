...
public function Header() {
        ...
        $this->Cell($this->PG_W, 8, "Shortlisted Candidates (OBC Category)", 0, 0, 'C');
        $this->Ln();
        ...
        $this->Ln();
        $this->SetFont('Arial', '', 12);
        $this->Cell($this->PG_W / 6, 5, "UG CGPA :", 0, 0, 'L');
        $this->Cell($this->PG_W / 4, 5, $this->ug, 0, 0, 'L');      
        $this->Cell($this->PG_W / 6, 5, "PG CGPA :", 0, 0, 'L');
...
$sql = 'SELECT * FROM selected where community = "OBC"';
...
$sql1 = 'SELECT count(Appl) FROM selected where community = "OBC"';
...
$sql2 = 'SELECT count(App_no) FROM list where community = "OBC"';
...
$sql3 = 'SELECT obc1,obc2 FROM criterion';
