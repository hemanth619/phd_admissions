...
class PHPMailer {
   ...
   * @var string
   */
  public $From              = 'samgatha.iiitdm@gmail.com';//'root@localhost';

  /**
   * Sets the From name of the message.
   * @var string
   */
  public $FromName          = 'Ph.D Admissions Admin';//'Root User'
   ...
   * @var string
   */
  public $Sender            = 'phdadmissionsiiitdm@gmail.com';//'';
   ...
   * @var string
   */
  public $Host          = 'smtp.gmail.com';//'localhost';
   ...
   * @var string
   */
  public $Username      = 'phdadmissionsiiitdm@gmail.com';

  /**
   * Sets SMTP password.
   * @var string
   */
  public $Password      = 'admissions6350';
