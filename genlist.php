...
public function Header() {
        ...
        $this->Cell($this->PG_W, 8, "Shortlisted Candidates (General Category)", 0, 0, 'C');
        $this->Ln();
...
$sql = 'SELECT * FROM selected where community = "General"';
...
$sql1 = 'SELECT count(Appl) FROM selected where community = "General"';
...
$sql2 = 'SELECT count(App_no) FROM list where community = "General"';
...
$sql3 = 'SELECT gn1,gn2 FROM criterion';
